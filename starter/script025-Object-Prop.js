...
console.log(moi);
console.log(`Je m'appelle ${moi.prenom} ${moi.nom}, j'ai ${moi.age} ans, je suis à présent un ${moi.profession} (métier) ${moi.nationalite} (nationalité) et je suis ${moi.etatCivil} (état civil)`);
